...
- 1fc84b9: The cellar index — a way to ask for a member's own cellar.
...
- Updated dependencies [afded61]
- Updated dependencies [1fc84b9]
  - @edwardseshoka/contracts@11.1.0

## 15.0.0

### Major Changes

- a2d8f6c: Rebuild the itinerary out of stops, and give a route's notes one ledger row.
...
- a2d8f6c: Four shapes the itinerary design needed, and one number that stops a chip reading as a bug.
  ...
  **`ItineraryStopContract.date`, an ISO calendar DAY.** A day and not an instant: two
  ...
  two routes has two meetings. Without a day, _first_ resolves to whichever route was
...
- Updated dependencies [a2d8f6c]
- Updated dependencies [a2d8f6c]
- Updated dependencies [a2d8f6c]
  - @edwardseshoka/contracts@11.0.0
