/**
 * Catalog's sample data — the only entry point a consumer of it needs.
 *
 ...
 * on a social one.
 */
export { CatalogSeedFactory } from "./CatalogSeedFactory.js";
export { createWines } from "./wines.js";
export { createWineRecord, createWineRecords } from "./wineRecords.js";
